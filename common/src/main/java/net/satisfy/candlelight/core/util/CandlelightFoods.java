...
public class CandlelightFoods {
    public static final FoodProperties TOMATO_SOUP = (new FoodProperties.Builder()).nutrition(6).saturationModifier(0.6F).build();
    public static final FoodProperties FILLET_STEAK = (new FoodProperties.Builder()).nutrition(8).saturationModifier(0.8F).build();
    public static final FoodProperties ROASTED_LAMB_WITH_LETTUCE = (new FoodProperties.Builder()).nutrition(8).saturationModifier(0.8F).build();
    public static final FoodProperties PORK_RIBS = (new FoodProperties.Builder()).nutrition(7).saturationModifier(0.8F).build();
