...
public class CandlelightChestplateRenderer implements ArmorRenderer {
    ...
    public void render(PoseStack matrices, MultiBufferSource vertexConsumers, ItemStack stack, LivingEntity entity, EquipmentSlot slot, int light, HumanoidModel<LivingEntity> contextModel) {
        ...
        Model model = ArmorRegistry.getChestplateModel(candlelightChestItem, contextModel.body, contextModel.leftArm, contextModel.rightArm, contextModel.leftLeg, contextModel.rightLeg);
        ResourceLocation base = candlelightChestItem.getChestplateTexture();
